        ...
        <nav
                ...
                <div className="relative flex h-16 items-center justify-between">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            ...
                            <span
                                   className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 cursor-default">Profil</span>
                            </div>
                        </div>
                    </div>
                    <div
            ...
            <div id="mobile-menu"
                ...
                <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <span
                       className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 cursor-default">Profil</span>
                </div>
            </div>
        </nav>
    );
